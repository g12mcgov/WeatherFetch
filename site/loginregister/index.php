...
<a name="toTop"></a>
	<nav class="navbar navbar-static-top" role="navigation">
		<ul class="nav navbar-nav pull-right">
			<li><a id="myAccount" href='login.php'>My Account</a></li>
		</ul>
	...
	<div class="centerPanel">
		<div class="container-fluid" id="registrationText">
			<h1>Hate your weather app? Join us!</h1>
		</div>
		  				...
		  				<div class="panel-body">
								<form role="form" id="registrationForm" method="post" action="" autocomplete="on">
									...
									<div class="form-group formbox">
										...
										<select name="time[]" data-max-options="2" tabindex="6" class="selectpicker" multiple>
	...
	<div class="row">
		...
		<div class="column2">
			<div class="col-md-4" id="two">
				<img src="../loginregister/img/iphone.gif" id="iPhone" align="middle">
			</div>
		</div>
		<div class="column3">
...
<div class="thirdFrame">
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<img src="../loginregister/img/clouds.png" id="clouds">
			</div>
		</div>
</div>
<div class="providers">
	<div class="container-fluid">
		<div class="row">
			<img class="img-responsive" src="../loginregister/img/weatherlogos.png" id="weatherLogos">		
		</div>
	</div>
</div>
<div class="fourthFrame">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-6">
				<img class="img-responsive" src="../loginregister/img/rain_clothing.svg">
			</div>
			<div class="col-md-6">
				<ul>
...
<div class="footer">
	<div class="container">
		<p class="text-muted">Developed with love by Grant McGovern</p>
