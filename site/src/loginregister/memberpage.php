		...
		<div class="row">
				...
				<div class="column_2">
					<div class="col-md-4">
						...
						<hr>
						<div style="background: none;" class="panel panel-default">
	  					<div style="background: none;" class="panel-heading">
	    					<h3 style="background: none;" class="panel-title">Username</h3>
	  					</div>
						...
						<div style="background: none;" class="panel panel-default">
	  					<div style="background: none;" class="panel-heading">
	    					<h3 style="background: none;" class="panel-title">Email</h3>
	  					</div>
	  					<div class="panel-body">
						...
						<div style="background: none;" class="panel panel-default">
	  					<div style="background: none;" class="panel-heading">
	    					<h3 style="background: none;" class="panel-title">Time</h3>
	  					</div>
	  					<div class="panel-body">
	    					<p><?php echo $Time ?></p>
	  					</div>
						...
						<div style="background: none;" class="panel panel-default">
	  					<div style="background: none;" class="panel-heading">
	    					<h3 style="background: none;" class="panel-title">Timezone</h3>
	  					</div>
	  					<div class="panel-body">
						...
						<div style="background: none;" class="panel panel-default">
	  					<div style="background: none;" class="panel-heading">
	    					<h3 style="background: none;" class="panel-title">Zipcode</h3>
	  					</div>
	  					<div class="panel-body">
						...
						<script src="../js/TimeSuccess.js"></script>
